...
export const dogData = {
  ...
  "behaviors": [
    { "keyword": "꼬리 축 처짐", "meaning": "불안, 두려움 또는 통증을 느끼고 있을 때 나타나는 행동입니다." },
    { "keyword": "바닥 긁기", "meaning": "자기 영역을 표시하거나 스트레스를 해소하는 행동입니다." },
    { "keyword": "계속 핥기", "meaning": "스트레스, 지루함 또는 알레르기 반응일 수 있습니다." },
    { "keyword": "원을 그리며 돌기", "meaning": "흥분 상태이거나 관심을 끌고 싶어하는 행동입니다." },
    { "keyword": "짖지 않고 입만 벌리기", "meaning": "스트레스나 불안감을 표현하는 신호입니다." }
  ],
  "supplements": [
    {
      "name": "오메가-3",
