...
export const forbiddenFoods = [
    {
        ...
        emergency: "즉시 구토를 유도하고 수의사에게 연락하세요. 활성탄 투여가 필요할 수 있습니다."
    },
    {
        name: "양파/마늘",
        risk: "high",
        reason: "적혈구를 손상시켜 빈혈을 유발할 수 있습니다. 모든 형태(생, 익힌 것, 가루)로 위험합니다.",
        emergency: "즉시 수의사에게 연락하고 구토를 유도하지 마세요. 혈액 검사가 필요할 수 있습니다."
    },
    {
        name: "포도/건포도",
        risk: "medium",
        reason: "신부전을 유발할 수 있습니다. 정확한 독성 물질과 작용 기전은 아직 밝혀지지 않았습니다.",
        emergency: "즉시 구토를 유도하고 수의사에게 연락하세요. 수액 치료가 필요할 수 있습니다."
    },
    {
        name: "자일리톨",
        risk: "high",
        reason: "인슐린 분비를 자극하여 혈당을 급격히 떨어뜨리고, 간부전을 유발할 수 있습니다.",
        emergency: "즉시 수의사에게 연락하고 혈당 모니터링이 필요합니다. 구토를 유도하지 마세요."
    },
    {
        name: "알코올",
        risk: "high",
        reason: "중추신경계 억제, 호흡 곤란, 혼수상태, 심지어 사망에 이르게 할 수 있습니다.",
        emergency: "즉시 수의사에게 연락하고 체온을 유지하세요. 구토를 유도하지 마세요."
    },
    {
        name: "카페인",
        risk: "medium",
        reason: "심박수 증가, 과민성, 불안, 구토, 설사를 유발할 수 있습니다.",
        emergency: "충분한 물을 공급하고 안정된 환경을 제공하세요. 심한 경우 수의사와 상담하세요."
    },
    {
        name: "아보카도",
        risk: "low",
        reason: "페르신이라는 성분이 구토와 설사를 유발할 수 있습니다. 고양이에게는 비교적 낮은 위험을 가집니다.",
        emergency: "충분한 물을 공급하고 증상을 관찰하세요. 심한 경우 수의사와 상담하세요."
    },
    {
        name: "날생선/날고기",
        risk: "medium",
        reason: "살모넬라 또는 리스테리아 감염의 위험이 있으며, 티아민 결핍을 유발할 수 있습니다.",
        emergency: "충분한 물을 공급하고 증상을 관찰하세요. 구토나 설사가 지속되면 수의사와 상담하세요."
    },
    {
        name: "뼈",
        risk: "medium",
        reason: "소화기관을 막거나 손상시킬 수 있으며, 특히 작은 뼈 조각이 위험합니다.",
        emergency: "구토를 유도하지 말고 즉시 수의사에게 연락하세요. X-ray 검사가 필요할 수 있습니다."
    },
    {
        name: "유제품",
        risk: "low",
        reason: "대부분의 고양이는 유당불내증이 있어 설사나 소화 불량을 일으킬 수 있습니다.",
        emergency: "충분한 물을 공급하고 증상을 관찰하세요. 탈수 방지를 위해 수분 섭취에 주의하세요."
    }
];
...
export const catBehaviors = [
    {
        ...
        tips: "골골거림은 대부분 긍정적이지만, 아플 때도 자가 치료를 위해 골골거릴 수 있습니다."
    },
    {
        title: "반죽하기",
        description: "앞발로 부드럽게 누르는 행동은 어릴 적 어미 고양이에게 젖을 먹던 행동에서 비롯됩니다. 편안함과 만족감을 나타냅니다.",
        image: "https://images.unsplash.com/photo-1622426348296-4499681139f4?w=300&h=200&fit=crop",
        tips: "고양이가 담요나 부드러운 표면에서 반죽하는 것을 좋아할 수 있습니다."
    },
    {
        title: "머리 들이밀기",
        description: "애정과 관심을 표현하는 행동입니다. 자신의 냄새를 묻혀 영역을 표시하고, 사회적 유대감을 형성하려는 시도입니다.",
        image: "https://images.unsplash.com/photo-1592417754307-59cdb7397492?w=300&h=200&fit=crop",
        tips: "머리를 들이미는 것은 고양이가 당신을 신뢰하고 편안하게 느낀다는 신호입니다."
    },
    {
        title: "핥아주기",
        description: "애정 표현의 한 형태로, 사회적 유대감을 강화하고 그룹의 일원임을 나타냅니다. 또한, 털을 정리해주는 행동일 수도 있습니다.",
        image: "https://images.unsplash.com/photo-1604949055944-6ff279751e4d?w=300&h=200&fit=crop",
        tips: "고양이가 핥아주는 것은 애정의 표현이지만, 때로는 과도한 관심의 표현일 수도 있습니다."
    },
    {
        title: "꼬리 흔들기",
        description: "고양이가 흥분했거나, 불안하거나, 짜증이 났을 때 꼬리를 흔들 수 있습니다. 개의 꼬리 흔들기와는 다른 의미를 가집니다.",
        image: "https://images.unsplash.com/photo-1561948955-570b270e7c36?w=300&h=200&fit=crop",
        tips: "빠르게 꼬리를 흔드는 것은 짜증이나 불만을 나타낼 수 있으며, 천천히 흔드는 것은 집중이나 흥미를 나타낼 수 있습니다."
    },
    {
        title: "하악질",
        description: "명백한 경고 신호로, 위협을 느끼거나 불편할 때 공격적인 의사를 표현하는 것입니다. 거리를 두라는 의미입니다.",
        image: "https://images.unsplash.com/photo-1543852786-1cf6624b9987?w=300&h=200&fit=crop",
        tips: "하악질을 할 때는 고양이에게서 물러서고, 위협적인 행동을 하지 않도록 주의해야 합니다."
    },
    {
        title: "털 세우기",
        description: "고양이가 두려움, 흥분, 또는 공격성을 느낄 때 털을 세울 수 있습니다. 이는 자신을 더 크게 보이게 하여 상대를 위협하려는 행동입니다.",
        image: "https://images.unsplash.com/photo-1591932584478-649a401b4542?w=300&h=200&fit=crop",
        tips: "털을 세우는 것은 고양이가 매우 불안하거나 위협을 느끼고 있다는 신호이므로, 안전한 거리를 유지하는 것이 중요합니다."
    },
    {
        title: "눈 깜빡이기",
        description: "느린 눈 깜빡임은 '고양이 키스'라고도 불리며, 신뢰와 편안함을 나타내는 신호입니다. 고양이가 당신을 편안하게 생각하고 있다는 긍정적인 표현입니다.",
        image: "https://images.unsplash.com/photo-1558578548-b2598a05ef48?w=300&h=200&fit=crop",
        tips: "고양이에게 천천히 눈을 깜빡여주면, 당신도 편안하고 우호적이라는 신호를 보낼 수 있습니다."
    },
    {
        title: "숨기",
        description: "불안하거나 스트레스를 받을 때 숨는 것은 고양이가 안전한 장소를 찾고 스스로를 보호하려는 본능적인 행동입니다.",
        image: "https://images.unsplash.com/photo-1549889741-66ca44a3e86b?w=300&h=200&fit=crop",
        tips: "고양이가 숨을 때는 억지로 꺼내려고 하지 말고, 스스로 나올 때까지 기다려주는 것이 좋습니다."
    },
    {
        title: "높은 곳에 오르기",
        description: "높은 곳에 올라 주변을 감시하는 것은 고양이에게 안전감을 제공하고, 영역을 확보하며, 잠재적인 위협을 감지하는 데 도움이 됩니다.",
        image: "https://images.unsplash.com/photo-1589923338643-350929a98577?w=300&h=200&fit=crop",
        tips: "고양이가 높은 곳에 쉽게 오를 수 있도록 캣타워나 선반 등을 마련해주는 것이 좋습니다."
    }
];
